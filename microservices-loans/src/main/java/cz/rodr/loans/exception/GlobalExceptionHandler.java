...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleLoanAlreadyExistsException(Exception exception, WebRequest request) {
    ...
    public ResponseEntity<ErrorResponseDto> handleLoanNotFoundException(Exception exception, WebRequest request) {
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(
                request.getDescription(false),
